...
class RagPipelineCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $documents = [
            ...
            'The laravel-langfuse package auto-instruments Laravel AI calls with zero configuration.',
        ];
        ...
        // --- Answer generation (auto-traced via LaravelAiSubscriber) ---
        $this->line('  <fg=gray>Step 3: Generating answer...</>');

        $response = RagAnswerer::make(context: $context)->prompt($question);
